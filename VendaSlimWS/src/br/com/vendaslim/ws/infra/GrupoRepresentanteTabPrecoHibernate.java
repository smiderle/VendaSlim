...
public class GrupoRepresentanteTabPrecoHibernate  extends RepositoryHibernate implements Repository{
	
	public List<GrupoRepresentanteTabPrecoIntegration> buscarPorDataAlteracao(Calendar dtHrAlteracao, Integer idEmpresa, Integer idFilial) {
		return this.session.createCriteria(GrupoRepresentanteTabPrecoIntegration.class)
